...
// 作业10-1和2Set.cpp : C作业101和2Set 类的实现
//
...
IMPLEMENT_DYNAMIC(C作业101和2Set, CRecordset)

C作业101和2Set::C作业101和2Set(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_ID = 0;
	column1 = L"";
...
// 储为其他格式或使用其他的用户身份验证。
CString C作业101和2Set::GetDefaultConnect()
{
...
CString C作业101和2Set::GetDefaultSQL()
{
	return _T("[学生信息表]");
}

void C作业101和2Set::DoFieldExchange(CFieldExchange* pFX)
{
...
#ifdef _DEBUG
void C作业101和2Set::AssertValid() const
{
	CRecordset::AssertValid();
}

void C作业101和2Set::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
